...
class AuthorizationServiceTest extends AbstractAuthorizationServiceTestCase
{
    ...
    public function testGetGrantedResourceActionsForCurrentUserWithRoles(): void
    {
        ...
        $roleItemUpdater = $this->internalResourceActionGrantService->addOrUpdateRole([],
            [
                ResourceActionGrantService::createRoleAction(
                    TestResources::TEST_RESOURCE_CLASS, TestResources::UPDATE_ACTION, AvailableResourceClassAction::ITEM_ACTION_TYPE),
            ]
        );
        $roleCollectionUpdater = $this->internalResourceActionGrantService->addOrUpdateRole([],
            [
                ResourceActionGrantService::createRoleAction(
    ...
    public function testGetGrantedResourceActionsForCurrentUserWithGroupResources(): void
    {
        ...
        $roleWriter = $this->internalResourceActionGrantService->addOrUpdateRole([],
            [
                ResourceActionGrantService::createRoleAction(
                    TestResources::TEST_RESOURCE_CLASS, TestResources::WRITE_ACTION, AvailableResourceClassAction::ITEM_ACTION_TYPE),
                ResourceActionGrantService::createRoleAction(
    ...
    {
        $roleReadAll = $this->internalResourceActionGrantService->addOrUpdateRole([],
            [
                ResourceActionGrantService::createRoleAction(
                    TestResources::TEST_RESOURCE_CLASS, TestResources::READ_ACTION, AvailableResourceClassAction::COLLECTION_ACTION_TYPE),
                // add some noise:
    ...
    public function testGetGrantedActionsCollectionForCurrentUserWithCommonResourceAttributes(): void
    {
    ...
    public function testGetGrantedActionsCollectionForCurrentUserOrderByAuthorizationResource(): void
    {
        // add grants unordered by resource to see if the result is ordered by resource (which the granted actions collection logic
        // depends on)
        $this->testEntityManager->addAuthorizationResourceAndActionGrant(
            self::TEST_RESOURCE_CLASS,
            self::TEST_RESOURCE_IDENTIFIER,
        ...
        $rag2 = $this->testEntityManager->addAuthorizationResourceAndActionGrant(
            self::TEST_RESOURCE_CLASS,
            self::TEST_RESOURCE_IDENTIFIER_2,
            action: AuthorizationService::MANAGE_ACTION,
        ...
        $this->testEntityManager->addResourceToResourceGroup(
            self::TEST_RESOURCE_CLASS, self::TEST_RESOURCE_GROUP_IDENTIFIER,
            self::TEST_RESOURCE_IDENTIFIER_2
        );

        $this->testEntityManager->addResourceActionGrant($rag2->getAuthorizationResource(),
            action: TestResources::READ_ACTION,
            userIdentifier: self::CURRENT_USER_IDENTIFIER
        );
        $this->testEntityManager->addResourceActionGrant($rag3->getAuthorizationResource(),
            action: TestResources::WRITE_ACTION,
            userIdentifier: self::CURRENT_USER_IDENTIFIER
        );
        ...
        $this->assertCount(1, $this->selectWhere($grantedActionsCollection,
        ...
        $this->assertCount(1, $this->selectWhere($grantedActionsCollection,
            function (GrantedActions $grantedActions) {
                return $grantedActions->getResourceClass() === self::TEST_RESOURCE_CLASS
                    && $grantedActions->getActions() === [TestResources::WRITE_ACTION]
                    && $grantedActions->getResourceIdentifier() === self::TEST_RESOURCE_IDENTIFIER.'_3';
            }
        ));
    }
    ...
    public function testGetResourceActionGrantsForResourceClassAndIdentifierWithRoles(): void
    {
        ...
        $roleManager = $this->internalResourceActionGrantService->addOrUpdateRole([],
            [
                ResourceActionGrantService::createRoleAction(
    ...
    public function testGetGrantedResourceActionsForCurrentForGroupItemResource(): void
    {
        ...
        $roleGroupManager = $this->internalResourceActionGrantService->addOrUpdateRole(
    ...
    {
        $roleGroupCreator = $this->internalResourceActionGrantService->addOrUpdateRole(
    ...
    {
        $roleUpdater = $this->internalResourceActionGrantService->addOrUpdateRole([],
            [
                ResourceActionGrantService::createRoleAction(
                    TestResources::TEST_RESOURCE_CLASS_2, TestResources::DELETE_ACTION, ResourceActionGrantService::ITEM_ACTION_TYPE),
                ResourceActionGrantService::createRoleAction(
        ...
        $roleRC3Delete = $this->internalResourceActionGrantService->addOrUpdateRole([],
            [
                ResourceActionGrantService::createRoleAction(
